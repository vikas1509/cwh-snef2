...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col  md:flex-row justify-between p-6 text-foreground w-full">
      <div className="flex flex-col justify-between w-full md:w-auto mb-8 md:mb-0">
        <div className="flex items-center h-12 w-fit p-2">
          <Image
