...
const StartCard: React.FC<StartCardProps> = ({ logo, text }) => {
  return (
    <Card className="w-[600px] h-32 bg-primary-foreground  shadow-sm rounded-lg overflow-hidden">
      <CardContent className="flex items-center gap-4  p-6">
        ...
        <div className="flex-grow">
          <p className="text-gray-800 font-semibold text-lg text-primary">
            {text ||
              "Add your Snef to your social media bio once, no need to update it ever again"}
          </p>
        </div>
      </CardContent>
    </Card>
